...
from fedml_api.model.cv.cnn import CNN_NCHCMNIST
from fedml_api.data_preprocessing.FederatedEMNIST.data_loader import load_partition_data_federated_emnist
from fedml_api.model.nlp.rnn import RNN_OriginalFedAvg, RNN_StackOverFlow

from fedml_api.data_preprocessing.MNIST.data_loader_2 import load_partition_data_mnist
...
def load_data(args, dataset_name):
    ...
    if dataset_name == "mnist":
        ...
        print(client_num, train_data_num, test_data_num)
...
if __name__ == "__main__":
    ...
    wandb.init(
        project="fedml",
        name="FedAVG-p" + str(args.client_num_in_total) + "-r" + str(args.comm_round) + "-e" + str(args.epochs),
        config=args
    )
    ...
    logger.info("client_num_in_total_before_load_data = " + str(args.client_num_in_total))
    # load data
    dataset = load_data(args, args.dataset)
    logger.info("client_num_in_total_after_load_data = " + str(args.client_num_in_total))
